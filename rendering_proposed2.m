function [Iv, Zv, AlphaV, Df, Db, Ifg, Ibg1, Ibg, alpha, Dbg, Ibgv, Ifgv] = rendering_proposed2(Cv, I1, Z1, C1, sigma_depth, hf_alpha, errosion_depth, errosion_fg, errosion_bg, inpaint_radius, inpaint_search)
if nargin < 5
    sigma_depth = 0.9;    
end
if nargin < 6
